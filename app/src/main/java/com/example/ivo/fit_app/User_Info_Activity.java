...
public class User_Info_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String[] s3 = new String[]{"Desk job with little exercise", "1-3 hrs/wk of light exercise", "3-5 hrs/wk of moderate exercise" ,"5-6 hrs/wk of strenuous exercise","7-21 hrs/wk of strenuous exercise"};
    ...
    String[] str1 = new String[] {"3 meals/day"};
    String[] str2 = new String[] {"4 meals/day"};
    String[] str3 = new String[] {"5 meals/day"};
    Integer mealcount = 0;
...
//There are multiple variations of this, but this is the basic variant.
        ...
        materialBetterSpinner4.setOnItemSelectedListener(this);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mealcount == 4){
                    Intent login_intent2 = new Intent(User_Info_Activity.this, User_Area_Activity4.class);
                    User_Info_Activity.this.startActivity(login_intent2);
                }
                if(mealcount == 5){
                    Intent login_intent3 = new Intent(User_Info_Activity.this, User_Area_Activity5.class);
                    User_Info_Activity.this.startActivity(login_intent3);
                }
            }
        });
        ...
        public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
            ...
            if(parentView.getItemAtPosition(position).toString().equals(str1)){
                mealcount = 3;
            }
            if(parentView.getItemAtPosition(position).toString().equals(str2)){
                mealcount = 4;
            }
            if(parentView.getItemAtPosition(position).toString().equals(str3)){
                mealcount = 5;
            }
